...
const Corps = () => {
  ...
  const produitsAffichesStockes = produitsStockes.filter((product) => product.subCategory === "corps");
  const produitsAffichesAPI = produitsAPI.filter((product) => product.subCategory === "corps");
