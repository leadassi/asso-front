...
const Habit = () => {
  ...
  const produitsAffichesStockes = produitsStockes.filter((product) => product.subCategory === "habit");

  // Produits venant de l'API (format 2 également)
  const produitsAffichesAPI = produitsAPI.filter((product) => product.subCategory === "habit");
