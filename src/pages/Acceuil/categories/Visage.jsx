...
const Visage = () => { // Nouveau nom du composant pour "Visage"
  ...
  const produitsAffichesStockes = produitsStockes.filter((product) => product.subCategory === "visage"); // Remplacer "cheveux" par "visage"

  // Produits venant de l'API (format 2 également)
  const produitsAffichesAPI = produitsAPI.filter((product) => product.subCategory === "visage"); // Remplacer "cheveux" par "visage"
...
export default Visage; // Changez également le nom du composant ici
