...
const Chapeaux = () => {
  const [category] = useState("Chapeaux");
  ...
  const filterByCriteria = (product) => {
    const match = {
      category: category === "Chapeaux" || product.category === category,
  ...
  const filteredProducts = chapeau.filter(filterByCriteria);

  return (
    <div className="clothing-page">
      <NavbarCategories />

      {/* Affichage des filtres uniquement pour la catégorie Chapeaux */}
      {category === "Chapeaux" && (
